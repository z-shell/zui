...
____
 ...
 Short button - no user data
 
 $1 - action ID
 $2 - text
 $3 - optional handler function name, can be empty text
 $4 - optional output variable name (default: 'reply')
____
...
____
 ...
 $1 - module's index
 $2 - instance index
 $3, $4, ... - additional arguments for the generator
____
...
____
 ...
 $2 - module's index
 $3 - instance index
 $4, $5, ... - additional arguments for the generator
____
